...
--
-- Хост: MySQL-8.4:3306
-- Время создания: Май 30 2026 г., 09:08
...
CREATE TABLE `request` (
  ...
  `curses` enum('Автобус','Элетробус','Трамвай') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `payment` enum('Карта','Наличные') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `users` (`id`, `fullname`, `years`, `phone`, `email`, `login`, `password`, `is_admin`, `created_at`, `review`) VALUES
(1, 'in', NULL, '+7(123)-456-78-90', '123@mail.ru', 'Admin26', 'Demo20', 1, '2025-10-09 15:57:44', NULL);
